...
# CC Compiler Flags
CCFLAGS=-Xcompiler="-O3 -Wall -fopenmp" --device-c
CXXFLAGS=-Xcompiler="-O3 -Wall -fopenmp" --device-c
...
${CND_DISTDIR}/${CND_CONF}/k-wave-fluid-cuda: ${OBJECTFILES}
	...
	nvcc -o ${CND_DISTDIR}/${CND_CONF}/k-wave-fluid-cuda ${OBJECTFILES} ${LDLIBSOPTIONS} -Xcompiler="-Wall -O3 -fopenmp"
