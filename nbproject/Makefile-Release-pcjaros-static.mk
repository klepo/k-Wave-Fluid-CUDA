...
CND_DLIB_EXT=so
CND_CONF=Release-pcjaros-static
CND_DISTDIR=dist
CND_BUILDDIR=build
...
# CC Compiler Flags
CCFLAGS=-m64 -Xcompiler="-O3 -Wall -fopenmp -mavx -march=native -mtune=native" -arch=compute_52 -code=sm_52 --device-c
CXXFLAGS=-m64 -Xcompiler="-O3 -Wall -fopenmp -mavx -march=native -mtune=native" -arch=compute_52 -code=sm_52 --device-c
...
${CND_DISTDIR}/${CND_CONF}/k-wave-fluid-cuda: ${OBJECTFILES}
	...
	nvcc -o ${CND_DISTDIR}/${CND_CONF}/k-wave-fluid-cuda ${OBJECTFILES} ${LDLIBSOPTIONS} -Xcompiler="-Wall -fopenmp -mavx" -arch=compute_52 -code=sm_52
...
${OBJECTDIR}/OutputHDF5Streams/BaseOutputHDF5Stream.o: OutputHDF5Streams/BaseOutputHDF5Stream.cpp
	...
	$(COMPILE.cc) -O3 -I./ -I${EBROOTHDF5}/include -std=c++11 -o ${OBJECTDIR}/OutputHDF5Streams/BaseOutputHDF5Stream.o OutputHDF5Streams/BaseOutputHDF5Stream.cpp

${OBJECTDIR}/OutputHDF5Streams/CuboidOutputHDF5Stream.o: OutputHDF5Streams/CuboidOutputHDF5Stream.cpp
	${MKDIR} -p ${OBJECTDIR}/OutputHDF5Streams
	$(COMPILE.cc) -O3 -I./ -I${EBROOTHDF5}/include -std=c++11 -o ${OBJECTDIR}/OutputHDF5Streams/CuboidOutputHDF5Stream.o OutputHDF5Streams/CuboidOutputHDF5Stream.cpp

${OBJECTDIR}/OutputHDF5Streams/IndexOutputHDF5Stream.o: OutputHDF5Streams/IndexOutputHDF5Stream.cpp
	${MKDIR} -p ${OBJECTDIR}/OutputHDF5Streams
	$(COMPILE.cc) -O3 -I./ -I${EBROOTHDF5}/include -std=c++11 -o ${OBJECTDIR}/OutputHDF5Streams/IndexOutputHDF5Stream.o OutputHDF5Streams/IndexOutputHDF5Stream.cpp

${OBJECTDIR}/OutputHDF5Streams/OutputStreamsCUDAKernels.o: OutputHDF5Streams/OutputStreamsCUDAKernels.cu
	${MKDIR} -p ${OBJECTDIR}/OutputHDF5Streams
	$(COMPILE.cc) -O3 -I./ -I${EBROOTHDF5}/include -std=c++11 -o ${OBJECTDIR}/OutputHDF5Streams/OutputStreamsCUDAKernels.o OutputHDF5Streams/OutputStreamsCUDAKernels.cu
