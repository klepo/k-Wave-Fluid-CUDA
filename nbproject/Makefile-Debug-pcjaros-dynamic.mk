...
CND_DLIB_EXT=so
CND_CONF=Debug-pcjaros-dynamic
CND_DISTDIR=dist
CND_BUILDDIR=build
...
# CC Compiler Flags
CCFLAGS=-m64 -Xcompiler=" -g3 -gdwarf-2  -Wall -fopenmp -mavx" -G -arch=compute_52 -code=sm_52 --device-c
CXXFLAGS=-m64 -Xcompiler=" -g3 -gdwarf-2  -Wall -fopenmp -mavx" -G -arch=compute_52 -code=sm_52 --device-c
...
${CND_DISTDIR}/${CND_CONF}/k-wave-fluid-cuda: ${OBJECTFILES}
	...
	nvcc -o ${CND_DISTDIR}/${CND_CONF}/k-wave-fluid-cuda ${OBJECTFILES} ${LDLIBSOPTIONS} -Xcompiler="-g3 -gdwarf-2 -Wall -fopenmp -mavx" -G -arch=compute_52 -code=sm_52
