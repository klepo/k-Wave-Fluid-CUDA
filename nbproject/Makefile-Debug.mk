...
${OBJECTDIR}/CUDA/CUDAImplementations.o: CUDA/CUDAImplementations.cu 
	...
	$(COMPILE.cc) -g -I./ -I/usr/local/hdf5-serial/include -std=c++11 -o ${OBJECTDIR}/CUDA/CUDAImplementations.o CUDA/CUDAImplementations.cu

${OBJECTDIR}/CUDA/CUDATuner.o: CUDA/CUDATuner.cpp 
	${MKDIR} -p ${OBJECTDIR}/CUDA
	$(COMPILE.cc) -g -I./ -I/usr/local/hdf5-serial/include -std=c++11 -o ${OBJECTDIR}/CUDA/CUDATuner.o CUDA/CUDATuner.cpp
