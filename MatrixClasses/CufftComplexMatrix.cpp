 ...
 *
 * @brief     The implementation file containing the class that implements various and 1D FFTs using the cuFFT
 * interface.
 *
...
std::map<cufftResult, ErrorMessage> CufftComplexMatrix::sCufftErrorMessages{
  {CUFFT_INVALID_PLAN, kErrFmtCufftInvalidPlan}, {CUFFT_ALLOC_FAILED, kErrFmtCufftAllocFailed},
  {CUFFT_INVALID_TYPE, kErrFmtCufftInvalidType}, {CUFFT_INVALID_VALUE, kErrFmtCufftInvalidValue},
  {CUFFT_INTERNAL_ERROR, kErrFmtCuFFTInternalError}, {CUFFT_EXEC_FAILED, kErrFmtCufftExecFailed},
  {CUFFT_SETUP_FAILED, kErrFmtCufftSetupFailed}, {CUFFT_INVALID_SIZE, kErrFmtCufftInvalidSize},
  {CUFFT_UNALIGNED_DATA, kErrFmtCufftUnalignedData},
  {CUFFT_INCOMPLETE_PARAMETER_LIST, kErrFmtCufftIncompleteParaterList},
  {CUFFT_INVALID_DEVICE, kErrFmtCufftInvalidDevice}, {CUFFT_PARSE_ERROR, kErrFmtCufftParseError},
  {CUFFT_NO_WORKSPACE, kErrFmtCufftNoWorkspace}, {CUFFT_NOT_IMPLEMENTED, kErrFmtCufftNotImplemented},
  {CUFFT_LICENSE_ERROR, kErrFmtCufftLicenseError}, {CUFFT_NOT_SUPPORTED, kErrFmtCufftNotSupported}};
//----------------------------------------------------------------------------------------------------------------------
...
void CufftComplexMatrix::createR2CFftPlanND(const DimensionSizes& inMatrixDims)
{
  ...
  {
    cufftError =
      cufftPlan2d(&sR2CFftPlanND, static_cast<int>(inMatrixDims.ny), static_cast<int>(inMatrixDims.nx), CUFFT_R2C);
  }
...
void CufftComplexMatrix::createC2RFftPlanND(const DimensionSizes& outMatrixDims)
{
  ...
  {
    cufftError =
      cufftPlan2d(&sC2RFftPlanND, static_cast<int>(outMatrixDims.ny), static_cast<int>(outMatrixDims.nx), CUFFT_C2R);
  }
...
void CufftComplexMatrix::createR2CFftPlan1DX(const DimensionSizes& inMatrixDims)
{
  ...
  if (sR2CFftPlan1DX)
  {
    ...
    if (cufftError != CUFFT_SUCCESS)
      throwCufftException(cufftError, kErrFmtDestroyR2CFftPlan1DY);
  }

  // plan the FFT
  cufftError =
    cufftPlanMany(&sR2CFftPlan1DX, rank, n, inembed, istride, idist, onembed, ostride, odist, CUFFT_R2C, batch);
...
void CufftComplexMatrix::createR2CFftPlan1DY(const DimensionSizes& inMatrixDims)
{
  ...
  cufftError =
    cufftPlanMany(&sR2CFftPlan1DY, rank, n, inembed, istride, idist, onembed, ostride, odist, CUFFT_R2C, batch);
...
void CufftComplexMatrix::createR2CFftPlan1DZ(const DimensionSizes& inMatrixDims)
{
  ...
  else
  {
    ...
    cufftError =
      cufftPlanMany(&sR2CFftPlan1DZ, rank, n, inembed, istride, idist, onembed, ostride, odist, CUFFT_R2C, batch);
...
void CufftComplexMatrix::createC2RFftPlan1DX(const DimensionSizes& outMatrixDims)
{
  ...
  cufftError =
    cufftPlanMany(&sC2RFftPlan1DX, rank, n, inembed, istride, idist, onembed, ostride, odist, CUFFT_C2R, batch);
...
void CufftComplexMatrix::createC2RFftPlan1DY(const DimensionSizes& outMatrixDims)
{
  ...
  cufftError =
    cufftPlanMany(&sC2RFftPlan1DY, rank, n, inembed, istride, idist, onembed, ostride, odist, CUFFT_C2R, batch);
...
void CufftComplexMatrix::createC2RFftPlan1DZ(const DimensionSizes& outMatrixDims)
{
  ...
  else
  {
    ...
    cufftError =
      cufftPlanMany(&sC2RFftPlan1DZ, rank, n, inembed, istride, idist, onembed, ostride, odist, CUFFT_C2R, batch);
...
void CufftComplexMatrix::destroyAllPlansAndStaticData()
{
  ...
  if (sR2CFftPlanND)
  {
    ...
    if (cufftError != CUFFT_SUCCESS)
      throwCufftException(cufftError, kErrFmtDestroyR2CFftPlanND);
  }
  ...
  if (sC2RFftPlanND)
  {
    ...
    if (cufftError != CUFFT_SUCCESS)
      throwCufftException(cufftError, kErrFmtDestroyC2RFftPlanND);
  }
  ...
  if (sR2CFftPlan1DX)
  {
    ...
    sR2CFftPlan1DX = cufftHandle();
    if (cufftError != CUFFT_SUCCESS)
      throwCufftException(cufftError, kErrFmtDestroyR2CFftPlan1DX);
  }
  ...
  if (sR2CFftPlan1DZ)
  {
    ...
    sR2CFftPlan1DZ = cufftHandle();
    if (cufftError != CUFFT_SUCCESS)
      throwCufftException(cufftError, kErrFmtDestroyR2CFftPlan1DZ);
  }
  ...
  if (sC2RFftPlan1DX)
  {
    ...
    sC2RFftPlan1DX = cufftHandle();
    if (cufftError != CUFFT_SUCCESS)
      throwCufftException(cufftError, kErrFmtDestroyC2RFftPlan1DX);
  }
  ...
  if (sC2RFftPlan1DY)
  {
    ...
    sC2RFftPlan1DY = cufftHandle();
    if (cufftError != CUFFT_SUCCESS)
      throwCufftException(cufftError, kErrFmtDestroyC2RFftPlan1DY);
  }
  ...
  if (sC2RFftPlan1DZ)
  {
    ...
    sC2RFftPlan1DZ = cufftHandle();
    if (cufftError != CUFFT_SUCCESS)
      throwCufftException(cufftError, kErrFmtDestroyC2RFftPlan1DZ);
  }
...
void CufftComplexMatrix::computeR2CFftND(RealMatrix& inMatrix)
{
  ...
  cufftResult_t cufftError = cufftExecR2C(
    sR2CFftPlanND, static_cast<cufftReal*>(inMatrix.getDeviceData()), reinterpret_cast<cufftComplex*>(mDeviceData));
...
{
  // Compute forward cuFFT (if the plan does not exist, it also returns error)
  cufftResult_t cufftError = cufftExecC2R(
    sC2RFftPlanND, reinterpret_cast<cufftComplex*>(mDeviceData), static_cast<cufftReal*>(outMatrix.getDeviceData()));
...
void CufftComplexMatrix::computeR2CFft1DX(RealMatrix& inMatrix)
{
  // Compute forward cuFFT (if the plan does not exist, it also returns error)
  cufftResult_t cufftError = cufftExecR2C(
    sR2CFftPlan1DX, static_cast<cufftReal*>(inMatrix.getDeviceData()), reinterpret_cast<cufftComplex*>(mDeviceData));
...
void CufftComplexMatrix::computeR2CFft1DY(RealMatrix& inMatrix)
{
  ...
  SolverCudaKernels::trasposeReal3DMatrixXY<SolverCudaKernels::TransposePadding::kOutput>(
    mDeviceData, inMatrix.getDeviceData(), dimSizes);
  ...
  cufftResult_t cufftError =
    cufftExecR2C(sR2CFftPlan1DY, static_cast<cufftReal*>(mDeviceData), reinterpret_cast<cufftComplex*>(mDeviceData));
...
void CufftComplexMatrix::computeR2CFft1DZ(RealMatrix& inMatrix)
{
  if (Parameters::getInstance().isSimulation3D())
  {
    ...
    // it does not request additional transfers and memory).
    cufftResult_t cufftError =
      cufftExecR2C(sR2CFftPlan1DZ, static_cast<cufftReal*>(mDeviceData), reinterpret_cast<cufftComplex*>(mDeviceData));
...
void CufftComplexMatrix::computeC2RFft1DX(RealMatrix& outMatrix)
{
  ...
  cufftResult_t cufftError = cufftExecC2R(
    sC2RFftPlan1DX, reinterpret_cast<cufftComplex*>(mDeviceData), static_cast<cufftReal*>(outMatrix.getDeviceData()));
...
void CufftComplexMatrix::computeC2RFft1DY(RealMatrix& outMatrix)
{
  ...
  // it does not request additional transfers and memory).
  cufftResult_t cufftError =
    cufftExecC2R(sC2RFftPlan1DY, reinterpret_cast<cufftComplex*>(mDeviceData), static_cast<cufftReal*>(mDeviceData));
  ...
  SolverCudaKernels::trasposeReal3DMatrixXY<SolverCudaKernels::TransposePadding::kInput>(
    outMatrix.getDeviceData(), mDeviceData, dimSizes);
...
void CufftComplexMatrix::computeC2RFft1DZ(RealMatrix& outMatrix)
{
  if (Parameters::getInstance().isSimulation3D())
  {
    ...
    // it does not request additional transfers and memory).
    cufftResult_t cufftError =
      cufftExecC2R(sC2RFftPlan1DZ, reinterpret_cast<cufftComplex*>(mDeviceData), static_cast<cufftReal*>(mDeviceData));
    ...
    SolverCudaKernels::trasposeReal3DMatrixXZ<SolverCudaKernels::TransposePadding::kInput>(
      outMatrix.getDeviceData(), getDeviceData(), DimSizes);
  }
  else
  {
 ...
 */
void CufftComplexMatrix::throwCufftException(const cufftResult cufftError, const std::string& transformTypeName)
{
  std::string errMsg;
