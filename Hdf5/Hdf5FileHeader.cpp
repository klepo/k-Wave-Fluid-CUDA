...
std::map<Hdf5FileHeader::FileHeaderItems, std::string> Hdf5FileHeader::sHeaderNames{
  ...
  {Hdf5FileHeader::FileHeaderItems::kPostProcessingTime, "post-processing_phase_execution_time"}}; // mHeaderNames
//----------------------------------------------------------------------------------------------------------------------
...
void Hdf5FileHeader::readHeaderFromInputFile(Hdf5File& inputFile) {
  ...
  if (getFileType() == FileType::kInput) {
    mHeaderValues[FHI::kCreatedBy] = inputFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kCreatedBy]);
    mHeaderValues[FHI::kCreationDate] = inputFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kCreationDate]);
    mHeaderValues[FHI::kFileDescription] = inputFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kFileDescription]);
    mHeaderValues[FHI::kMajorVersion] = inputFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kMajorVersion]);
    mHeaderValues[FHI::kMinorVersion] = inputFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kMinorVersion]);
  } else {
...
void Hdf5FileHeader::readHeaderFromOutputFile(Hdf5File& outputFile) {
  ...
  if (getFileType() == FileType::kOutput) {
    mHeaderValues[FHI::kTotalExecutionTime] = outputFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kTotalExecutionTime]);
    mHeaderValues[FHI::kDataLoadTime] = outputFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kDataLoadTime]);
    mHeaderValues[FHI::kPreProcessingTime] = outputFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kPreProcessingTime]);
    mHeaderValues[FHI::kSimulationTime] = outputFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kSimulationTime]);
    mHeaderValues[FHI::kPostProcessingTime] = outputFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kPostProcessingTime]);
  } else {
...
void Hdf5FileHeader::readHeaderFromCheckpointFile(Hdf5File& checkpointFile) {
  ...
  if (getFileType() == FileType::kCheckpoint) {
    mHeaderValues[FHI::kCreatedBy] = checkpointFile.readStringAttribute(group, "/", sHeaderNames[FHI::kCreatedBy]);
    mHeaderValues[FHI::kCreationDate] = checkpointFile.readStringAttribute(group, "/", sHeaderNames[FHI::kCreationDate]);
    mHeaderValues[FHI::kFileDescription] = checkpointFile.readStringAttribute(group, "/", sHeaderNames[FHI::kFileDescription]);
    mHeaderValues[FHI::kMajorVersion] = checkpointFile.readStringAttribute(group, "/", sHeaderNames[FHI::kMajorVersion]);
    mHeaderValues[FHI::kMinorVersion] = checkpointFile.readStringAttribute(group, "/", sHeaderNames[FHI::kMinorVersion]);
  } else {
...
Hdf5FileHeader::FileVersion Hdf5FileHeader::getFileVersion() {
  if ((mHeaderValues[FileHeaderItems::kMajorVersion] == kMajorFileVersionsNames[0]) && (mHeaderValues[FileHeaderItems::kMinorVersion] == kMinorFileVersionsNames[0])) {
    return FileVersion::kVersion10;
  }

  if ((mHeaderValues[FileHeaderItems::kMajorVersion] == kMajorFileVersionsNames[0]) && (mHeaderValues[FileHeaderItems::kMinorVersion] == kMinorFileVersionsNames[1])) {
...
void Hdf5FileHeader::setMemoryConsumption(const size_t totalMemory) {
  ...
  mHeaderValues[FileHeaderItems::kPeakMemoryConsumption] = Logger::formatMessage("%ld MB", totalMemory / Parameters::getInstance().getNumberOfThreads());
...
void Hdf5FileHeader::setNumberOfCores() {
  mHeaderValues[FileHeaderItems::kNumberOfCores] = Logger::formatMessage("%ld", Parameters::getInstance().getNumberOfThreads());
