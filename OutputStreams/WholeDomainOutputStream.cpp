...
void WholeDomainOutputStream::sample() {
  switch (mReduceOp) {
    ...
    case ReduceOperator::kRms: {
      OutputStreamsCudaKernels::sampleAll<ReduceOperator::kRms>(mDeviceBuffer,
    ...
    case ReduceOperator::kMax: {
      OutputStreamsCudaKernels::sampleAll<ReduceOperator::kMax>(mDeviceBuffer,
                                                                mSourceMatrix.getDeviceData(),
                                                                mSourceMatrix.size());
      break;
    } //case kMax
    ...
    case ReduceOperator::kMin: {
      OutputStreamsCudaKernels::sampleAll<ReduceOperator::kMin>(mDeviceBuffer,
                                                                mSourceMatrix.getDeviceData(),
                                                                mSourceMatrix.size());
      break;
    } //case kMin
