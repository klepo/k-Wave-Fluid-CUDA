...
class TParameters {
    public:
        ...
        /// Set simulation time step -- should be used only when recovering
        //  from checkpoint
        ...
        TSensorMaskType Get_sensor_mask_type()   const {return sensor_mask_type;};
        ...
        size_t  Get_sensor_mask_corners_size()     const {
            return sensor_mask_corners_size;
        };
        ...
        string GetInputFileName()      const {
            return command_line_parameters.GetInputFileName();
        };
        /// Get output file name
        string GetOutputFileName()     const {
            return command_line_parameters.GetOutputFileName();
        };
        /// Get checkpoint filename
        string GetCheckpointFileName() const {
            return command_line_parameters.GetCheckpointFileName();
        };

        /// Get compression level
        int GetCompressionLevel() const {
            return command_line_parameters.GetCompressionLevel();
        };
        /// Get number of threads
        int GetNumberOfThreads() const {
            return command_line_parameters.GetNumberOfThreads();
        };
        /// Get verbose interval
        int GetVerboseInterval() const {
            return command_line_parameters.GetVerboseInterval();
        };

        /// Get start time index for sensor recording
        int GetStartTimeIndex() const {
            return command_line_parameters.GetStartTimeIndex();
        };
        ...
        int  GetCheckpointInterval()   const {
            return command_line_parameters.GetCheckpointInterval();
        };

        /// Is --version specified at the command line
        bool IsVersion()     const {return command_line_parameters.IsVersion();};
        /// Is  -p or --p_raw specified at the command line
        bool IsStore_p_raw() const {return command_line_parameters.IsStore_p_raw();};
        /// Is --p_rms specified at the command line
        bool IsStore_p_rms() const {return command_line_parameters.IsStore_p_rms();};
        /// Is --p_max specified at the command line
        bool IsStore_p_max() const {return command_line_parameters.IsStore_p_max();};
        /// Is --p_min specified at the command line
        bool IsStore_p_min() const {return command_line_parameters.IsStore_p_min();};
        /// Is --p_max_all specified at the command line
        bool IsStore_p_max_all() const {
            return command_line_parameters.IsStore_p_max_all();
        };
        /// Is --p_min_all specified at the command line
        bool IsStore_p_min_all() const {
            return command_line_parameters.IsStore_p_min_all();
        };
        /// Is  --p_final specified at the command line
        bool IsStore_p_final() const {
            return command_line_parameters.IsStore_p_final();
        };

        /// Is -u or --u_raw specified at the command line
        bool IsStore_u_raw() const {return command_line_parameters.IsStore_u_raw();};
        /// Is --u_non_staggered_raw set?
        bool IsStore_u_non_staggered_raw()  const {
            return command_line_parameters.IsStore_u_non_staggered_raw();
        };
        /// Is --u_raw specified at the command line
        bool IsStore_u_rms() const {return command_line_parameters.IsStore_u_rms();};
        /// Is --u_max specified at the command line
        bool IsStore_u_max() const {return command_line_parameters.IsStore_u_max();};
        /// Is --u_min specified at the command line
        bool IsStore_u_min() const {return command_line_parameters.IsStore_u_min();};
        /// Is --u_max_all specified at the command line
        bool IsStore_u_max_all() const {
            return command_line_parameters.IsStore_u_max_all();
        };
        ...
        bool IsStore_I_avg() const {return command_line_parameters.IsStore_I_avg();};
        /// Is --I_max specified at the command line
        bool IsStore_I_max() const {return command_line_parameters.IsStore_I_max();};

        /// is --copy_mask set
        bool IsCopySensorMask() const {
            return command_line_parameters.IsCopySensorMask();
        };
    ...
    protected:
        ...
        /// Class with commandlie parameters
        TCommandLineParameters command_line_parameters;
        ...
        /// singleton instance
        static TParameters *ParametersSingle;
