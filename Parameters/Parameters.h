...
class Parameters
{
  public:
    ...
    {
      return mCommandLineParameters.isPrintVersionOnly();
    };
     ...
     */
    const CudaParameters& getCudaParameters() const
    {
      return mCudaParameters;
    };
     ...
     * @return CudaParameters class.
     */
    CudaParameters& getCudaParameters()
    {
      return mCudaParameters;
    };
    ...
    {
      return mCommandLineParameters.getNumberOfThreads();
    };
    ...
    {
      return mCommandLineParameters.getCompressionLevel();
    };
     ...
     */
    float getProgressPrintInterval() const
    {
      return mCommandLineParameters.getProgressPrintInterval();
    };
    ...
    {
      return mCommandLineParameters.isCheckpointEnabled();
    };
    ...
    {
      return mCommandLineParameters.getInputFileName();
    };
    ...
    {
      return mCommandLineParameters.getOutputFileName();
    };
    ...
    {
      return mCommandLineParameters.getCheckpointFileName();
    };
     ...
     */
    size_t getNoCompressionOverlapFlag() const
    {
      return mCommandLineParameters.getNoCompressionOverlapFlag();
    }
    /**
     * @brief  Get 40-bit compression flag.
     * @return 40-bit compression flag.
     */
    size_t get40bitCompressionFlag() const
    {
      return mCommandLineParameters.get40bitCompressionFlag();
    }
    /**
    ...
    {
      return mCommandLineParameters.getBlockSize();
    }
     ...
     */
    bool isSimulation2D() const
    {
      return mFullDimensionSizes.is2D();
    };
    /**
     * @brief  Is the simulation executed in 3 dimensions.
     * @return True if the simulation space is 3D.
     */
    bool isSimulation3D() const
    {
      return !isSimulation2D();
    }
    /**
    ...
    {
      return mInitialPressureSourceFlag;
    };
    ...
    {
      return mPressureSourceIndexSize;
    }
    ...
    {
      return mTransducerSourceInputSize;
    }
    ...
    {
      return mVelocitySourceIndexSize;
    }
     ...
     */
    SourceMode getPressureSourceMode() const
    {
      return mPressureSourceMode;
    };
     ...
     * @return Pressure source mode.
     */
    SourceMode getVelocitySourceMode() const
    {
      return mVelocitySourceMode;
    };
    ...
    {
      return mCommandLineParameters.getSamplingStartTimeIndex();
    };
    ...
    {
      return mCommandLineParameters.getStorePressureRawFlag();
    };
    /**
     * @brief  Is --p_c set?
     * @return True if the flag is set.
     */
    bool getStorePressureCFlag() const
    {
      return mCommandLineParameters.getStorePressureCFlag();
    };
    /**
     * @brief  Is --p_rms set?
     * @return True if the flag is set.
    ...
    {
      return mCommandLineParameters.getStorePressureRmsFlag();
    };
    /**
     * @brief  Is --p_max set?
     * @return True if the flag is set.
    ...
    {
      return mCommandLineParameters.getStorePressureMaxFlag();
    };
    /**
     * @brief  Is --p_min set?
     * @return True if the flag is set.
    ...
    {
      return mCommandLineParameters.getStorePressureMinFlag();
    };
    /**
    ...
    {
      return mCommandLineParameters.getStorePressureMaxAllFlag();
    };
    /**
    ...
    {
      return mCommandLineParameters.getStorePressureMinAllFlag();
    };
    /**
    ...
    {
      return mCommandLineParameters.getStorePressureFinalAllFlag();
    };
    ...
    {
      return mCommandLineParameters.getStoreVelocityRawFlag();
    };
    /**
     * @brief  Is --u_c set?
     * @return True if the flag is set.
     */
    bool getStoreVelocityCFlag() const
    {
      return mCommandLineParameters.getStoreVelocityCFlag();
    };
    /**
    ...
    {
      return mCommandLineParameters.getStoreVelocityRmsFlag();
    };
    /**
     * @brief  Is --u_max set?
     * @return True if the flag is set.
    ...
    {
      return mCommandLineParameters.getStoreVelocityMaxFlag();
    };
    /**
     * @brief  Is --u_min set?
     * @return True if the flag is set.
    ...
    {
      return mCommandLineParameters.getStoreVelocityMinFlag();
    };
    /**
    ...
    {
      return mCommandLineParameters.getStoreVelocityMaxAllFlag();
    };
    /**
     * @brief  Is --u_min set?
     * @return True if the flag is set.
    ...
    {
      return mCommandLineParameters.getStoreVelocityMinAllFlag();
    };
    /**
    ...
    {
      return mCommandLineParameters.getStoreVelocityFinalAllFlag();
    };
    /**
     * @brief  Is --I_avg set?
     * @return True if the flag is set.
     */
    bool getStoreIntensityAvgFlag() const
    {
      return mCommandLineParameters.getStoreIntensityAvgFlag();
    };
    /**
     * @brief  Is --I_avg_c set?
     * @return True if the flag is set.
     */
    bool getStoreIntensityAvgCFlag() const
    {
      return mCommandLineParameters.getStoreIntensityAvgCFlag();
    };
    /**
     * @brief  Is --Q_term set?
     * @return True if the flag is set.
     */
    bool getStoreQTermFlag() const
    {
      return mCommandLineParameters.getStoreQTermFlag();
    };
    /**
     * @brief  Is --Q_term_c set?
     * @return True if the flag is set.
     */
    bool getStoreQTermCFlag() const
    {
      return mCommandLineParameters.getStoreQTermCFlag();
    };
    /**
     * @brief  Is --post set?
     * @return True if the flag is set.
     */
    bool getOnlyPostProcessingFlag() const
    {
      return mCommandLineParameters.getOnlyPostProcessingFlag();
    };
    /**
    ...
    {
      return mCommandLineParameters.getCopySensorMaskFlag();
    };
