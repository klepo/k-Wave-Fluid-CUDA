...
struct DimensionSizes
{
     ...
     */
    DimensionSizes(size_t x, size_t y, size_t z = 1, size_t t = 0) : nx(x), ny(y), nz(z), nt(t){};
     ...
     */
    inline friend DimensionSizes operator-(const DimensionSizes& op1, const DimensionSizes& op2)
    {
      ...
      {
        return DimensionSizes(op1.nx - op2.nx + 1, op1.ny - op2.ny + 1, op1.nz - op2.nz + 1, op1.nt - op2.nt + 1);
      }
    };
